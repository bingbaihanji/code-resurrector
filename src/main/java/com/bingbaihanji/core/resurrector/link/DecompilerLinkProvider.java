...
public class DecompilerLinkProvider implements LinkProvider {
    ...
    private String erasePackageInfoFromDesc(String desc) {
        ...
        // 匹配常见的包名模式
        // 包括：java.lang., com.example., org.apache. 等
        String packagePattern = "\\b(?:[a-zA-Z_$][\\w$]*\\.)+(?![^.]*\\.)";
        return desc.replaceAll(packagePattern, "");
    }
