package com.bingbaihanji.core.resurrector.listener;
...
public class DropListener implements DropTargetListener {
    private static final Logger logger = LoggerFactory.getLogger(DropListener.class);
                    ...
                    try {
                        ...
                        while ((line = br.readLine()) != null) {
                            try {
                                ...
                                logger.warn("Error processing dropped file URI", ex);
                            }
                        }
                        if (list.size() > 1) {
                            event.rejectDrop();
