...
import com.bingbaihanji.code.resurrector.decompiler.BytecodeCache;
import com.bingbaihanji.code.resurrector.exception.BinaryFileException;
import com.bingbaihanji.code.resurrector.exception.FileEntryNotFoundException;
import com.bingbaihanji.code.resurrector.exception.FileSizeExceededException;
import com.bingbaihanji.code.resurrector.io.JarEntryFilter;
import com.bingbaihanji.code.resurrector.ui.component.CellRenderer;
import com.bingbaihanji.code.resurrector.util.ResourceCloser;
import com.bingbaihanji.code.resurrector.view.FindBox;
...
public class Model extends JSplitPane {
    ...
    public void updateTree() {
        com.bingbaihanji.code.resurrector.util.TreeNodeUtils treeUtil = new com.bingbaihanji.code.resurrector.util.TreeNodeUtils(tree);
    ...
    public void closeFile() {
        ...
        if (oldState != null) {
            com.bingbaihanji.code.resurrector.util.ResourceCloser.tryClose(oldState);
        }
    ...
    public static class Tab extends JPanel {
        ...
        public Tab(String title, final Callable<Void> onCloseTabAction) {
            ...
            // 使用统一的图标管理器加载关闭图标
            this.closeButton = new JLabel(com.bingbaihanji.code.resurrector.util.IconResourceManager.loadCloseIcon());
