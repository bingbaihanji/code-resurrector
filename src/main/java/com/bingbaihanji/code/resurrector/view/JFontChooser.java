...
public class JFontChooser extends JComponent {
     ...
     * 获取所选字体的样式。
     *
     * @return 所选字体的样式。<code>Font.PLAIN</code>,
     ...
     * 设置所选字体的样式。
     *
     * @param style 所选字体的大小。<code>Font.PLAIN</code>,
     *              <code>Font.BOLD</code>, <code>Font.ITALIC</code>, 或
     *              <code>Font.BOLD|Font.ITALIC</code>.
     * @see java.awt.Font#PLAIN
     * @see java.awt.Font#BOLD
     * @see java.awt.Font#ITALIC
     ...
     * @return OK_OPTION, CANCEL_OPTION 或 ERROR_OPTION
     * @see #OK_OPTION
     * @see #CANCEL_OPTION
     * @see #ERROR_OPTION
     **/
    ...
    protected JDialog createDialog(Component parent) {
        ...
        JDialog dialog = new JDialog(frame, ("选择一个字体"), true);
    ...
    protected JPanel getSamplePanel() {
        if (samplePanel == null) {
            Border titledBorder = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ("示例"));
