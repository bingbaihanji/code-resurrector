            ...
            if (decompiler instanceof ProcyonDecompiler) {
                ...
                if (type != null) {
                    ...
                    if (bytecode != null) {
                        ...
                        String errorMsg = "／／ 无法获取字节码: " + typeName + "\n";
                        errorMsg += "／／ 请确认文件已从 JAR 加载\n";
                        errorMsg += "／／ 建议切换回 Procyon 引擎";
